            ...
            <div class="ibox-content mailbox-content">
                <div class="file-manager">
                    ...
                    <ul class="folder-list m-b-md" style="padding: 0">
                        <li>
                            <a href="{{ route('admin.article.index') }}"> <i class="fa fa-inbox "></i> 已发布 <span class="label label-warning pull-right">{{ $status_num[1] }}</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.article.index',['status' => 0]) }}"> <i class="fa fa-file-text-o"></i> 草稿 <span class="label label-danger pull-right">{{ $status_num[0] }}</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.article.index',['status' => 2]) }}"> <i class="fa fa-trash-o"></i> 垃圾箱 <span class="label label-danger pull-right">{{ $status_num[2] }}</a>
                        </li>
                    </ul>
                    <h5>分类</h5>
                    ...
                    @foreach($lists as $v)
                        <tr class="">
                            ...
                            <td class="text-right mail-date">
                                <a onclick="location.href='{{ route('admin.article.update' ,['id' => $v['id']]) }}';" class="btn btn-sm btn-info">编辑</a>
