...
<script src="{{ skinPath() }}js/bootstrap.min.js?v=3.3.5"></script>
<script src="{{ skinPath() }}js/plugins/metisMenu/jquery.metisMenu.js"></script>
<script src="{{ skinPath() }}js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
<script src="{{ skinPath() }}js/plugins/layer/layer.min.js"></script>
<script src="{{ skinPath() }}js/manage.js?v=4.0.0"></script>
<script type="text/javascript" src="{{ skinPath() }}js/contabs.min.js"></script>
<script src="{{ skinPath() }}js/plugins/pace/pace.min.js"></script>
</body>
</html>