                    ...
                    @if($lists->count())
                        @foreach($lists as $v)
                            <tr>
                                ...
                                <td>{{ $v->updated_at }}</td>
                                <td>
                                    <a class="btn btn-sm btn-info" href="{{ route('admin.contract-tpl.edit', ['id' => $v->id]) }}">编辑</a>
                                    <button class="btn btn-sm btn-danger" onclick="Delete('{{ editURL('admin.contract-tpl.destroy', $v->id) }}')">删除</button>
                                </td>
                            </tr>
                        @endforeach
                    @else
