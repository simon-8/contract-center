...
return [
    ...
    'admin.ajax.index' => 'ajax接口',

    'admin.ad.*' => '广告管理',
    'admin.ad.index' => '广告列表',
    'admin.ad.create' => '添加广告',
    'admin.ad.edit' => '编辑广告',
    'admin.ad.destroy' => '删除广告',
    'admin.ad.show' => '广告详情',
    ...
    'admin.ad-place.*' => '广告位管理',
    'admin.ad-place.index' => '广告位列表',
    'admin.ad-place.create' => '添加广告位',
    'admin.ad-place.edit' => '编辑广告位',
    'admin.ad-place.destroy' => '删除广告位',
    'admin.ad-place.show' => '广告详情',
    ...
    'admin.menu.show' => '菜单详情',

    'admin.manager.*' => '管理员管理',
    'admin.manager.index' => '管理员列表',
    'admin.manager.create' => '添加管理员',
    ...
    'admin.role-access.create' => '添加权限',
    'admin.role-access.edit' => '编辑权限',
    'admin.role-access.destroy' => '删除权限',
    'admin.role-access.show' => '权限详情',
    ...
    'admin.contract-category.*' => '合同类型',
    'admin.contract-category.index' => '类型列表',
    'admin.contract-category.create' => '添加类型',
    'admin.contract-category.edit' => '编辑类型',
    'admin.contract-category.destroy' => '删除类型',
    'admin.contract-category.show' => '类型详情',

    'admin.contract-tpl.*' => '合同模板管理',
    'admin.contract-tpl.index' => '合同模板列表',
    'admin.contract-tpl.create' => '合同模板添加',
    'admin.contract-tpl.edit' => '合同模板编辑',
    'admin.contract-tpl.destroy' => '合同模板删除',
    'admin.contract-tpl.show' => '合同模板详情',

    'admin.contract-tpl-section.*' => '模板模块管理',
    'admin.contract-tpl-section.index' => '模板模块列表',
    'admin.contract-tpl-section.create' => '模板模块添加',
    'admin.contract-tpl-section.edit' => '模板模块编辑',
    'admin.contract-tpl-section.destroy' => '模板模块删除',
    'admin.contract-tpl-section.show' => '模板模块详情',
